...
import static xyz.jzab.abapiBackend.constant.UserConstant.USER_LOGIN_STATE;
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            String accessKey = DigestUtils.md5DigestAsHex(
                (SALT+userAccount+ RandomUtil.randomNumbers(5)).getBytes()
            );
            String secretKey = DigestUtils.md5DigestAsHex(
                (SALT+userPassword+ RandomUtil.randomNumbers(5)).getBytes()
            );
            // 3. 插入数据
            User user = new User();
